...
var Picker = require('emoji-picker-react');
var reactMenu = require('@szhsin/react-menu');
var reactResponsiveModal = require('react-responsive-modal');
...
var GlobalProvider = function (_a) {
    ...
    var currentUserData = React.useState(currentUser)[0];
    var _b = React.useState([]), data = _b[0], setData = _b[1];
    var _c = React.useState([]), editArr = _c[0], setEdit = _c[1];
    var _d = React.useState([]), replyArr = _d[0], setReply = _d[1];
...
var EmojiInput = function (_a) {
    ...
    var _c = React.useState(), chosenEmoji = _c[0], setChosenEmoji = _c[1];
    var wrapperRef = React.useRef(null);
    useOutsideAlerter(wrapperRef, setOpen);
    var globalStore = React.useContext(GlobalContext);
    React.useEffect(function () {
        if (chosenEmoji) {
    ...
    return (React.createElement("div", { className: 'emoji-input' },
        React.createElement("input", { className: 'postComment', style: mode === 'replyMode' || mode === 'editMode'
        ...
        React.createElement("div", { className: 'emoji-icon', onClick: function () { return setOpen(!open); } }),
        open ? (React.createElement("div", { ref: wrapperRef },
            React.createElement(Picker, { onEmojiClick: onEmojiClick }))) : null));
};
...
var RegularInput = function (_a) {
    ...
    var globalStore = React.useContext(GlobalContext);
    return (React.createElement("form", { className: 'form', style: globalStore.formStyle || formStyle, onSubmit: function () { return handleSubmit; } },
        React.createElement("div", { className: 'userImg', style: imgDiv },
            React.createElement("a", { target: '_blank', href: globalStore.currentUserData.currentUserProfile },
                React.createElement("img", { src: globalStore.customImg ||
                        customImg ||
                        globalStore.currentUserData.currentUserImg, style: globalStore.imgStyle || imgStyle, alt: 'userIcon', className: 'imgdefault' }))),
        globalStore.removeEmoji ? (React.createElement("input", { className: 'postComment', style: mode === 'replyMode' || mode === 'editMode'
                ? globalStore.replyInputStyle
                : globalStore.inputStyle || inputStyle, type: 'text', placeholder: placeHolder ? placeHolder : 'Type your reply here.', value: text, onChange: function (e) { return setText(e.target.value); } })) : (React.createElement(EmojiInput, { text: text, setText: setText, mode: mode, inputStyle: inputStyle, placeHolder: placeHolder })),
        mode && (React.createElement("button", { className: 'cancelBtn', style: globalStore.cancelBtnStyle || cancelBtnStyle, type: 'button', onClick: function () {
                return mode === 'editMode'
                    ? globalStore.handleAction(comId, true)
                    : globalStore.handleAction(comId, false);
            } }, "Cancel")),
        React.createElement("button", { className: 'postBtn', type: 'submit', disabled: text != '' ? false : true, style: globalStore.submitBtnStyle || submitBtnStyle, onClick: function (e) { return (text ? handleSubmit(e) : null); } }, "Post")));
};
...
var AdvancedInput = function (_a) {
    ...
    var globalStore = React.useContext(GlobalContext);
    var _b = React.useState('<p></p>'), html = _b[0], setHtml = _b[1];
    var _c = React.useState('<p></p>'), editText = _c[0], setEditText = _c[1];
    React.useEffect(function () {
        if (text !== '') {
    ...
    return (React.createElement("div", { className: 'advanced-overlay' },
        React.createElement("div", { className: 'userImg', style: imgDiv },
            React.createElement("a", { target: '_blank', href: globalStore.currentUserData.currentUserProfile, rel: 'noreferrer' },
                React.createElement("img", { src: globalStore.customImg ||
                        customImg ||
                        globalStore.currentUserData.currentUserImg, style: globalStore.imgStyle || imgStyle, alt: 'userIcon', className: 'imgdefault' }))),
        React.createElement("div", { className: 'advanced-input' },
            React.createElement("form", { className: 'form advanced-form ', style: globalStore.formStyle || formStyle, onSubmit: onSubmit },
                React.createElement("div", { className: 'advanced-border' },
                    React.createElement("div", { className: 'advanced-editor', contentEditable: true, suppressContentEditableWarning: true, onInput: onInput, dangerouslySetInnerHTML: {
                            __html: html === '<p></p>' ? '' : html
                        }, "aria-label": placeHolder ? placeHolder : 'Type your reply here.' })),
                React.createElement("div", { className: 'advanced-btns' },
                    mode && (React.createElement("button", { className: 'advanced-cancel cancelBtn', style: globalStore.cancelBtnStyle || cancelBtnStyle, type: 'button', onClick: function () {
                            return mode === 'editMode'
                                ? globalStore.handleAction(comId, true)
                                : globalStore.handleAction(comId, false);
                        } }, "Cancel")),
                    React.createElement("button", { className: 'advanced-post postBtn', type: 'submit', disabled: !canSubmit, style: globalStore.submitBtnStyle || submitBtnStyle }, "Post"))))));
};
...
var DeleteModal = function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { width: '100%' }, onClick: onOpenModal }, "delete"),
        React.createElement(reactResponsiveModal.Modal, { open: open, onClose: onCloseModal, center: true },
            React.createElement("h2", null, "Are you sure?"),
            React.createElement("p", null, "Once you delete this comment it will be gone forever."),
            React.createElement("div", { className: 'deleteBtns' },
                React.createElement("button", { className: 'delete', onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                ...
                React.createElement("button", { className: 'cancel', onClick: onCloseModal }, "Cancel")))));
};
...
var CommentStructure = function (_a) {
    ...
    var optionsMenu = function () {
        return (React.createElement("div", { className: "userActions" }, info.userId === currentUser.currentUserId && (React.createElement(reactMenu.Menu, { menuButton: React.createElement("button", { className: "actionsBtn" },
                ' ',
                React.createElement("div", { className: "optionIcon" })) },
            React.createElement(reactMenu.MenuItem, { onClick: function () { return globalStore.handleAction(info.comId, true); } }, "edit"),
            !disableDeleteAction && (React.createElement(reactMenu.MenuItem, null,
                React.createElement(DeleteModal, { comId: info.comId, parentId: parentId })))))));
    };
    ...
    var userInfo = function () {
        return (React.createElement("div", { className: "commentsTwo" },
            React.createElement("a", { className: "userLink", target: "_blank", href: info.userProfile },
                React.createElement("div", null,
                    React.createElement("img", { src: info.avatarUrl, alt: "userIcon", className: "imgdefault", style: globalStore.imgStyle ||
                            (!globalStore.replyTop
                                ? { position: 'relative', top: 7 }
                                : null) })),
                React.createElement("div", { className: "fullName" },
                    info.fullName,
                    React.createElement("span", { className: "commenttimestamp" }, showTimestamp &&
                        (info.timestamp == null ? null : timeAgo(info.timestamp)))))));
    };
    var replyTopSection = function () {
        return (React.createElement("div", { className: "halfDiv" },
    ...
    var replyBottomSection = function () {
        return (React.createElement("div", { className: "halfDiv" },
            React.createElement("div", { className: "userInfo" },
                userInfo(),
                globalStore.advancedInput ? (React.createElement("div", { className: "infoStyle", dangerouslySetInnerHTML: {
                        __html: info.text
                    } })) : (React.createElement("div", { className: "infoStyle" }, info.text)),
                React.createElement("div", { style: { marginLeft: 32 } },
                    ' ',
                    (currentUser && !disableReplySecoundLevelAction) && (React.createElement("div", null,
                        React.createElement("button", { className: "replyBtn", onClick: function () { return globalStore.handleAction(info.comId, false); } },
                            React.createElement("div", { className: "replyIcon" }),
                            React.createElement("span", { style: { marginLeft: 17 } }, "Reply")))))),
            currentUser && optionsMenu()));
    };
    var actionModeSection = function (mode) {
        if (mode === 'reply') {
            return (React.createElement("div", { className: "replysection" },
                globalStore.replyTop ? replyTopSection() : replyBottomSection(),
                React.createElement(InputField, { formStyle: {
            ...
            return (React.createElement(InputField, { formStyle: {
                    backgroundColor: 'transparent',
                    padding: '20px 0px',
                    marginLeft: '-15px'
    ...
    return (React.createElement("div", null, editMode
...
var LoginSection = function (_a) {
    ...
    return (React.createElement("div", { className: 'signBox' },
        React.createElement("div", { className: 'signLine' }, "Log in or sign up to leave a comment"),
        React.createElement("div", null,
            React.createElement("button", { className: 'loginBtn', name: 'login', onClick: handleLoginClick }, "Log In"),
            React.createElement("button", { className: 'signBtn', name: 'signup', onClick: handleSignUpClick }, "Sign Up"))));
};

var NoComments = function () {
    return (React.createElement("div", { className: 'no-comDiv' },
        ' ',
...
var CommentSection$1 = function (_a) {
    ...
    var loginMode = function () {
        return React.createElement(LoginSection, { loginLink: handleLogin, signUpLink: handleSignUp });
    };
    var globalStore = React.useContext(GlobalContext);
    ...
    return (React.createElement("div", { className: 'overlay', style: overlayStyle },
        React.createElement("span", { className: 'comment-title', style: titleStyle },
            globalStore.commentsCount || totalComments(),
            ' ',
            totalComments() === 1 ? 'Comment' : 'Comments'),
        React.createElement("hr", { className: 'hr-style', style: hrStyle }),
        globalStore.currentUserData === null ? (loginMode()) : (React.createElement(InputField, { placeHolder: globalStore.placeHolder, formStyle: { margin: '10px 0px' }, imgDiv: { margin: 0 } })),
        renderData.length > 0 ? (renderData.map(function (i) {
            return (React.createElement("div", { key: i.comId },
                React.createElement(CommentStructure, { info: i, editMode: _.indexOf(globalStore.editArr, i.comId) !== -1, replyMode: _.indexOf(globalStore.replyArr, i.comId) !== -1, logIn: logIn, showTimestamp: showTimestamp, disableDeleteAction: disableDeleteAction }),
                i.replies &&
                    i.replies.length > 0 &&
                    i.replies.map(function (j) {
                        return (React.createElement("div", { className: 'replySection', key: j.comId },
                            React.createElement(CommentStructure, { info: j, parentId: i.comId, editMode: _.indexOf(globalStore.editArr, j.comId) !== -1, replyMode: _.indexOf(globalStore.replyArr, j.comId) !== -1, logIn: logIn, showTimestamp: showTimestamp, disableDeleteAction: disableDeleteAction, disableReplySecoundLevelAction: disableReplySecoundLevelAction })));
                    })));
        })) : customNoComment ? (customNoComment()) : (React.createElement(NoComments, null))));
};
